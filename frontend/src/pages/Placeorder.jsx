...
const Placeorder = () => {
  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      let orderData = {
        ...
        userId: token,  // or backend extracts from token
        address: formData,
        items: orderItems,
        amount: getCartAmount() + delivery_fee,
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-4 min-h-[80h] border-t'>
      {/* Left side */}
